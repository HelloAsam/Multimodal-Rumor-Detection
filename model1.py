...
# ============================================
# 模块 6. 定义多模态模型（冻结预训练模型 + 打印参数量）
# ============================================
class MultiModalModel(nn.Module):
    def __init__(self, bert, vit, social_dim=16, hidden_dim=256, num_classes=2, freeze_backbone=True):
        super().__init__()
        self.bert = bert
        self.vit = vit
...
# 模块 8. 模型测试前向
# ============================================
model = MultiModalModel(bert_model, vit_model).to(DEVICE)
